          ...
          <div>
            ...
            <div className="mt-2 space-y-2.5">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <label className="block">
                  <Label text={t('patientFormModal.chiefComplaint')} />
                  <textarea value={value.chief_complaint} onChange={set('chief_complaint')} rows={2} maxLength={2000} placeholder={t('patientFormModal.healthHint')} className={`resize-none ${FIELD}`} />
                </label>
              </div>
            </div>
          </div>
