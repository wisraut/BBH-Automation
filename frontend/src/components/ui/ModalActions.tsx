...
export function ModalActions({ children }: { children: ReactNode }) {
  return (
    <div className="sticky bottom-0 z-10 -mx-4 -mb-5 flex flex-col-reverse gap-2 border-t border-bbh-line bg-white px-4 py-3 md:-mx-7 md:px-7 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
      {children}
    </div>
  )
}
